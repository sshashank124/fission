...
impl Triangle {
    #[inline] fn a(&self) -> P { self.mesh_data.p[self.f[0] as usize] }
    #[inline] fn b(&self) -> P { self.mesh_data.p[self.f[1] as usize] }
    #[inline] fn c(&self) -> P { self.mesh_data.p[self.f[2] as usize] }

    #[inline] fn an(&self) -> N { self.mesh_data.n[self.f[0] as usize] }
    #[inline] fn bn(&self) -> N { self.mesh_data.n[self.f[1] as usize] }
    #[inline] fn cn(&self) -> N { self.mesh_data.n[self.f[2] as usize] }

    #[inline] fn at(&self) -> F2
    { self.mesh_data.uv[self.f[0] as usize] }
    #[inline] fn bt(&self) -> F2
    { self.mesh_data.uv[self.f[1] as usize] }
    #[inline] fn ct(&self) -> F2
