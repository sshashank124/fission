...
impl Warp2<()> for UniformDisk {
    ...
    #[inline(always)] fn pdf(_: F2, _: ()) -> F { F::INV_PI }
}
...
impl Warp3<()> for CosineHemisphere {
    ...
    #[inline(always)] fn pdf(s: F3, _: ()) -> F { Frame::ct(s) * F::INV_PI }
}
...
impl Warp3<()> for UniformCylinder {
    ...
    #[inline(always)] fn pdf(_: F3, _: ()) -> F { F::INV_4PI }
}
...
impl Warp3<()> for UniformHemisphere {
    ...
    #[inline(always)] fn pdf(_: F3, _: ()) -> F { F::INV_2PI }
}
...
impl Warp3<F> for BeckmannHemisphere {
    ...
    #[inline(always)] fn pdf(s: F3, alpha: F) -> F {
